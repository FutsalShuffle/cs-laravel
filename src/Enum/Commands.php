...
final class Commands
{
    ...
    public const CODE_STYLE_FIX = 'docker run -it --rm -v $(pwd):/code ghcr.io/php-cs-fixer/php-cs-fixer:3-php8.3 fix --path-mode=intersection --config ./vendor/futsalshuffle/cs-laravel/.php_cs-fixer.php --allow-risky=yes';
    public const CODE_STYLE_CHECK = 'docker run -it --rm -v $(pwd):/code ghcr.io/php-cs-fixer/php-cs-fixer:3-php8.3 fix --path-mode=intersection --config ./vendor/futsalshuffle/cs-laravel/.php_cs-fixer.php --allow-risky=yes --dry-run';
